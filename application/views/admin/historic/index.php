      ...
      <thead>
          <tr class="filters">
            ...
            <th id="filter_col12" data-column="12">
              <input style="width:70px" class="column_filter form-control" id="col12_filter" type="text" placeholder="Status Cota" disabled><span style="display:none">Status Cota</span>
            </th>
